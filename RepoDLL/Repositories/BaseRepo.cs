...
namespace RepoDLL.Repositories {
    public class BaseRepo {
        ...
        protected string GetFileFromAssembly(string fileName) {
            ...
            if (assemblyFile == null) {
                ...
                string content = new System.IO.StreamReader(_assembly.GetManifestResourceStream(assemblyFile) ?? throw new Exception($"File {fileName} not found in assembly.")).ReadToEnd();
                return content;
            }
